...
/*			N.loader.lazyLoader.js(N.EXTERNALTOOLS.config.baiduComponentJsImporter, function(){
	 ...
	 */
	N.dom._useAdvancedSelector = function(){
		if(_gwBuffer['sizzle']){
